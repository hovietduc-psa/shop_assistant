"""Consolidated database schema with users, conversations, messages, and analytics
Combines migrations 001, a4178eb31991, 47cdd40a14b1, and b947dd71c64d into a single migration

Revision ID: 002
Revises:
Create Date: 2025-10-27 08:52:00.000000
...
def upgrade() -> None:
    ...
    op.create_table('conversation_analytics',
        ...
        # Note: No foreign key constraint as per migration b947dd71c64d
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('system_metrics',
        ...
        sa.Column('tags', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('system_metadata', postgresql.JSON(astext_type=sa.Text()), nullable=True),
